...
public class PatternLayout extends PatternLayoutBase<ILoggingEvent> {
    ...
    public String doLayout(ILoggingEvent event) {
        ...
        sb.append(getFileHeader()).append(writeLoopOnConverters(event)).append("\n").append(getFileFooter());
//    String str = writeLoopOnConverters(event);
//    android.util.Log.w("Zero","doLayout: " + str);
        return sb.toString();
    }
}
