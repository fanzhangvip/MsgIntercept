...
import ch.qos.logback.classic.util.Utils;
...
public final class Logger implements org.slf4j.Logger, LocationAwareLogger, BLog,
...
//    private final ThreadLocal<String> localTags = new ThreadLocal<String>();
    ...
    Logger(String name, Logger parent, LoggerContext loggerContext) {
        ...
        mLogConfig.configTagPrefix(name);
     ...
     * @param args
     */
    private synchronized void logString(@Level.LevelIntType int type, String msg, Object... args) {
...
//        }
     ...
     * @param object
     */
    private void logObject(@Level.LevelIntType int type, Object object) {
    ...
    public void d(String message, Object... args) {
        logString(Level.DEBUG_INT, message, args);
    }

    @Override
    public void d(Object object) {
        logObject(Level.DEBUG_INT, object);
    }

    @Override
    public void e(String message, Object... args) {
        logString(Level.ERROR_INT, message, args);
    }

    @Override
    public void e(Object object) {
        logObject(Level.ERROR_INT, object);
    }

    @Override
    public void w(String message, Object... args) {
        logString(Level.WARN_INT, message, args);
    }

    @Override
    public void w(Object object) {
        logObject(Level.WARN_INT, object);
    }

    @Override
    public void i(String message, Object... args) {
        logString(Level.INFO_INT, message, args);
    }

    @Override
    public void i(Object object) {
        logObject(Level.INFO_INT, object);
    }

    @Override
    public void v(String message, Object... args) {
        logString(Level.TRACE_INT, message, args);
    }

    @Override
    public void v(Object object) {
        logObject(Level.TRACE_INT, object);
    }
    ...
    private void printLog(@Level.LevelIntType int type, String tag, String msg) {
//        android.util.Log.e("Zero", getTopStackInfo());
        if (!mLogConfig.isShowBorder()) {
    ...
    private void printLog(@Level.LevelIntType int type, String msg) {
//        android.util.Log.e("Zero", getTopStackInfo());
        if (!mLogConfig.isShowBorder()) {
            msg = getTopStackInfo() + ": " + msg;
        }
